  ...
  return (
    <section id="mission" className="relative py-28 lg:py-36 bg-brand-grey-light overflow-hidden">
      ...
      <img
        src={leafImg}
        alt=""
        className="absolute top-1/2 -translate-y-1/2 -right-[12%] w-[450px] opacity-[0.07] select-none pointer-events-none"
      />
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        ...
        <div className="mt-14 grid lg:grid-cols-2 gap-6">
          <motion.div className="border border-brand-grey/20 rounded-sm p-10 lg:p-12 bg-brand-white" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.6 }}>
          ...
          <motion.div className="border border-brand-grey/20 rounded-sm p-10 lg:p-12 bg-brand-white" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.6, delay: 0.1 }}>
            <div className="flex items-center gap-3 mb-6">
