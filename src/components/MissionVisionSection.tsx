  ...
  return (
    <section id="mission" className="relative py-28 lg:py-36 bg-brand-grey-light overflow-hidden">
      <img
        src={leafImg}
        alt=""
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] opacity-[0.06] select-none pointer-events-none"
      />
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        ...
        <div className="mt-14 grid lg:grid-cols-2 gap-6">
          {/* Mission */}
          <motion.div
            className="border border-brand-grey/20 rounded-sm p-10 lg:p-12 bg-brand-white"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <h3 className="text-xl lg:text-2xl font-heading font-bold text-brand-black leading-snug">
