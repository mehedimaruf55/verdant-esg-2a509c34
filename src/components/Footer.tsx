        ...
        <div className="py-14 grid md:grid-cols-3 gap-10 items-start">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a href="#about" className="text-[14px] text-brand-white/60 hover:text-brand-white transition-colors">About</a>
              <a href="#services" className="text-[14px] text-brand-white/60 hover:text-brand-white transition-colors">Services</a>
              <a href="#why" className="text-[14px] text-brand-white/60 hover:text-brand-white transition-colors">Why Verdant</a>
              <a href="#contact" className="text-[14px] text-brand-white/60 hover:text-brand-white transition-colors">Contact</a>
            </div>
          </div>
          <div>
