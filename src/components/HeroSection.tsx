  ...
  return (
    <section className="relative min-h-[85dvh] flex flex-col justify-between overflow-hidden" style={{ background: "linear-gradient(135deg, #76f7bf 0%, #499167 40%, #3a7a5a 100%)" }}>
      ...
      <motion.img
        src={leafImg}
        alt=""
        className="absolute top-[8%] -right-[5%] w-[55vw] max-w-[800px] min-w-[280px] opacity-[0.70] select-none pointer-events-none grayscale brightness-[1.65] contrast-75 mix-blend-screen"
      ...
      <motion.img
        src={leafImg}
        alt=""
        className="absolute -bottom-[10%] -left-[12%] w-[35vw] max-w-[500px] opacity-[0.45] select-none pointer-events-none rotate-[140deg] hidden sm:block grayscale brightness-[1.55] contrast-75 mix-blend-screen"
        initial={{ opacity: 0 }}
