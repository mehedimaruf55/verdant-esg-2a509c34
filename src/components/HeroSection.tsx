  ...
  return (
    <section className="relative min-h-[100dvh] flex flex-col justify-end overflow-hidden pt-16 bg-brand-green-dark">
      ...
      <img
        src={leafImg}
        alt=""
        className="absolute top-1/2 -translate-y-1/2 -right-[15%] w-[600px] opacity-[0.08] select-none pointer-events-none"
      />
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-end">
          ...
          >
            ...
            <a href="#contact" className="group inline-flex items-center gap-3 self-start">
              <span className="px-6 py-3.5 text-[13px] font-semibold tracking-wide bg-brand-white text-brand-green-dark rounded-full group-hover:bg-brand-grey-light transition-colors">Get Started</span>
