...
const HeroSection = () => {
  return (
    <section className="relative min-h-[85dvh] flex flex-col justify-between overflow-hidden" style={{ background: "linear-gradient(135deg, #6ABA45 0%, #3a7a3a 40%, #326234 100%)" }}>
      {/* Leaf — large, beautifully visible, right-aligned */}
      <motion.img
        src={leafImg}
        alt=""
        className="absolute top-[8%] -right-[5%] w-[55vw] max-w-[800px] min-w-[280px] opacity-[0.18] select-none pointer-events-none"
      ...
      <motion.img
        src={leafImg}
        alt=""
        className="absolute -bottom-[10%] -left-[12%] w-[35vw] max-w-[500px] opacity-[0.07] select-none pointer-events-none rotate-[140deg] hidden sm:block"
        initial={{ opacity: 0 }}
