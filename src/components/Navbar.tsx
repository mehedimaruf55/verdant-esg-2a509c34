    ...
    <div className="fixed inset-x-0 top-0 z-50 flex justify-center pointer-events-none px-3 lg:px-0">
      ...
      >
        ...
        <div className="hidden lg:flex items-center">
          ...
          <a
            href="/contact"
            className="ml-3 px-5 py-2 text-[12px] font-bold uppercase tracking-[0.14em] bg-brand-green-dark text-brand-white rounded-full hover:bg-brand-green-light hover:text-brand-black hover:shadow-[0_4px_20px_-4px_rgba(106,186,69,0.4)] transition-all duration-300 active:scale-[0.97]"
          >
            Contact
          </a>
        </div>
          ...
          >
            ...
            <div className="px-4 py-4 flex flex-col gap-0.5 max-h-[65vh] overflow-y-auto">
              ...
              <motion.a
                ...
                className="mt-3 text-center px-5 py-3 text-[11px] font-bold uppercase tracking-[0.14em] bg-brand-green-dark text-brand-white rounded-full hover:bg-brand-green-light hover:text-brand-black transition-all duration-300"
              >
                Contact
              </motion.a>
            </div>
