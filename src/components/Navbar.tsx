...
const navLinks: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: "Overview", href: "/services" },
      {
        ...
        children: [
          { label: "Sustainability for Planning", href: "/services/sustainability-for-planning" },
          { label: "Environmental Assessment", href: "/services/environmental-assessment" },
          { label: "BREEAM Certification", href: "/services/breeam-certification" },
          { label: "WELL Certification", href: "/services/well-certification" },
          { label: "Building Performance", href: "/services/building-performance" },
          { label: "Biodiversity", href: "/services/biodiversity" },
          { label: "Life Cycle Assessment", href: "/services/life-cycle-assessment" },
        ],
      },
      {
        ...
        children: [
          ...
          { label: "Real Estate ESG", href: "/services/real-estate-esg" },
          { label: "Net Zero Carbon", href: "/services/net-zero-carbon" },
          { label: "Climate Resilience", href: "/services/climate-resilience" },
          { label: "TCFD & TNFD Advisory", href: "/services/tcfd-tnfd-advisory" },
        ],
      },
      {
        label: "PPN Compliance Services",
        href: "/services/ppn-002",
        children: [
          { label: "PPN 002", href: "/services/ppn-002" },
          { label: "PPN 006", href: "/services/ppn-006" },
          { label: "PPN 016", href: "/services/ppn-016" },
        ],
      },
      {
        ...
        children: [
          { label: "Business Carbon Footprint", href: "/services/business-carbon-footprint" },
          { label: "Building Carbon Footprint", href: "/services/building-carbon-footprint" },
          { label: "Product Carbon Footprint", href: "/services/product-carbon-footprint" },
          { label: "Event Carbon Footprint", href: "/services/event-carbon-footprint" },
        ],
      },
      {
        label: "Carbon Credits & Offsetting",
        href: "/services/carbon-credits-offsetting",
        children: [
          { label: "Biochar", href: "/services/biochar" },
        ],
      },
      {
        label: "Certification",
        ...
        children: [
          { label: "BREEAM", href: "/services/breeam-certification" },
          { label: "WELL", href: "/services/well-certification" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    href: "/resources",
    children: [
      { label: "CPD Sessions", href: "/resources/cpd-sessions" },
      { label: "Masterclass", href: "/resources/masterclass" },
      { label: "Planning Tool", href: "/resources/planning-tool" },
    ],
  },
];
