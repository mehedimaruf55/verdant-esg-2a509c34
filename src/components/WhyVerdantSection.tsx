...
const WhyVerdantSection = () => {
  return (
    <section id="why" className="relative py-20 lg:py-36 overflow-hidden" style={{ background: "linear-gradient(135deg, #3a7a5a 0%, #499167 60%, #76f7bf 100%)" }}>
      <motion.img
        src={leafImg}
        alt=""
        className="absolute bottom-[5%] -left-[6%] w-[45vw] max-w-[600px] min-w-[200px] opacity-[0.62] select-none pointer-events-none rotate-[-20deg] hidden sm:block grayscale brightness-[1.55] contrast-75 mix-blend-screen"
        initial={{ opacity: 0, rotate: -25 }}
        whileInView={{ opacity: 0.46, rotate: -20 }}
        viewport={{ once: true }}
